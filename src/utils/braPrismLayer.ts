...
/** 원추면 재구성 파라미터 — TrackMap 이 렌더하는 원추면 메시와 **동일한 라이브 값**을 넣는다.
 *  (결과 스냅샷을 넣으면 각도/높이 변경 직후 재분석이 끝날 때까지 "원추면 위인데 회색" 어긋남이 생긴다.
 *   프리즘 집합은 결과 스냅샷, 색 분할면은 라이브 원추면 — 2026-08-12 계약) */
