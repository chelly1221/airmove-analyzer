...
const REPORT_TRACK_PHASES: Record<string, TourStep[]> = {
  ...
  drawing: [
    {
      ...
      title: "비행검사기 선택",
      body: "비행검사기를 선택하세요. 등록된 기체의 Mode-S 주소로 항적을 필터링합니다.",
      mode: "interactive",
      placement: "right",
    ...
    },
    {
      ...
      title: "ASS 파일 열기",
      body: "'ASS 파일 열기'로 레이더 저장자료(ASS)를 불러오세요.",
      waitBody: "파싱·통합이 끝나면 자동으로 다음 단계로 넘어갑니다…",
      mode: "interactive",
      placement: "bottom",
      advanceOnTargetClick: true,
      waitAfterClick: true,
      advanceWhen: (s, b) => s.flights.length > b.flights.length && !s.consolidating,
      showNext: true,
    },
    {
      id: "drawing-capture",
      title: "항적도 캡처",
      body:
        "항적이 표시되면 화면을 정리한 뒤 **Win + Shift + S** 로 스크린샷을 캡처하세요. " +
        "이 이미지가 보고서 첨부용 항적도입니다.",
      mode: "floating",
      showNext: true,
    },
    {
  ...
  trackmap: [
    ...
    },
    {
      ...
      title: "ASS 파일 열기",
      body: "'ASS 파일 열기'로 동일한 ASS 파일을 불러오세요.",
      waitBody: "파싱·통합이 끝나면 자동으로 다음 단계로 넘어갑니다…",
      mode: "interactive",
      placement: "bottom",
      advanceOnTargetClick: true,
    ...
    },
    {
      id: "tm-capture",
      title: "지도 화면 캡처",
      body: "**Win + Shift + S** 로 지도 화면을 캡처하세요. 항적 점 표시 화면이 보고서 첨부용입니다.",
      mode: "floating",
      showNext: true,
    },
    {
...
export const TOUR_SCENARIOS: TourScenarioMeta[] = [
  {
    ...
    stepsSummary: [
      "단일항적분석 창에서 비행검사기·레이더 선택 후 ASS 파일 열기",
